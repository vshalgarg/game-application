...
const TambolaGameRoom = () => {
  ...
  // Temporary UI state.
  // This will later come from your realtime/game API.
  ...
  const [lastCalled, setLastCalled] = useState(31);
  ...
  return (
    <PageShell>
      <div className="relative flex min-h-[calc(100vh-2rem)] w-full flex-col gap-3 py-2">
        ...
        <div className="w-full rounded-2xl border border-gz-primary-cyan/50 bg-gz-popup/80 px-4 py-3 shadow-[0_0_25px_rgba(34,211,238,0.08)] backdrop-blur-xl">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* Players */}
              <div className="flex items-center gap-2">
                <FaUsers className="text-gz-primary-cyan" size={18} />
            ...
            <div className="flex items-center justify-center gap-6">
              ...
              <div className="text-center">
                <div className="mx-auto flex h-11 w-11 items-center justify-center rounded-full border border-gz-input-border/60 bg-gz-popup">
                  <span className="text-lg font-bold text-gz-text">0</span>
                </div>
              ...
              <button
                ...
                className={`flex h-11 w-11 items-center justify-center rounded-xl transition ${
                  soundOn
                    ? "bg-gz-purple-accent text-white shadow-[0_0_18px_rgba(168,85,247,0.35)]"
                    : "border border-gz-input-border/60 bg-gz-popup text-gz-text-secondary"
                }`}
              >
                <FaVolumeUp size={16} />
              </button>
        ...
        {/* ================= MAIN GAME AREA ================= */}
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 xl:grid-cols-[1.25fr_1fr]">
          {/* ================= NUMBER BOARD ================= */}
          <div className="flex min-h-0 flex-col rounded-2xl border border-gz-primary-cyan/50 bg-gz-popup/80 p-4 shadow-[0_0_25px_rgba(34,211,238,0.08)] backdrop-blur-xl">
            ...
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <FaTh className="text-gz-primary-cyan" size={17} />
            ...
            {/* Numbers */}
            <div className="grid flex-1 grid-cols-5 gap-1.5 sm:grid-cols-6 md:grid-cols-9">
              {numbers.map((number) => {
                ...
                return (
                  <button
                    key={number}
                    type="button"
                    className={`relative flex min-h-[38px] items-center justify-center rounded-lg border text-xs font-semibold transition-all ${
                      isLastCalled
          ...
          <div className="flex min-h-0 flex-col gap-3">
            ...
            <div className="rounded-2xl border border-gz-primary-cyan/50 bg-gz-popup/80 p-4 shadow-[0_0_20px_rgba(34,211,238,0.07)] backdrop-blur-xl">
              <div className="mb-3 flex items-center justify-between">
                ...
                <span className="text-xs font-medium text-gz-text-secondary">
                  Ticket #5
                </span>
              </div>
                  ...
                  {ticketNumbers.flat().map((number) => {
                    ...
                    return (
                      <button
                        key={number}
                        type="button"
                        onClick={() => handleTicketNumberClick(number)}
            ...
            {/* ================= CLAIMS ================= */}
            <div className="min-h-0 rounded-2xl border border-gz-purple-accent/50 bg-gz-popup/80 p-4 shadow-[0_0_20px_rgba(168,85,247,0.07)] backdrop-blur-xl">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="rounded-full border border-fuchsia-500/40 bg-fuchsia-500/10 px-3 py-1 text-[10px] font-semibold text-fuchsia-300">
                  Current Target: Early Five
                </span>
              </div>
              ...
              <div className="flex flex-col">
                {claims.map((claim) => {
                  ...
                  return (
                    <div
                      key={claim.id}
                      className="flex items-center gap-3 border-b border-gz-input-border/40 py-2 last:border-b-0"
                    >
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gz-primary-cyan/15 text-gz-primary-cyan">
                        <Icon size={14} />
                      </div>

                      <div className="min-w-0 flex-1">
                        <p className="text-xs font-bold text-gz-text">
                          {claim.title}
                        </p>

                        <p className="truncate text-[9px] text-gz-text-secondary">
                          {claim.description}
                        </p>
                      </div>
                      ...
                      <button
                        type="button"
                        className="rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 px-4 py-2 text-[10px] font-bold text-white shadow-[0_0_10px_rgba(34,211,238,0.25)] transition hover:scale-[1.02]"
                      >
                        Claim
                      </button>
                    </div>
            ...
            <button
              type="button"
              className="flex items-center gap-3 rounded-2xl border border-gz-purple-accent/40 bg-gz-popup/80 p-3 text-left shadow-[0_0_18px_rgba(168,85,247,0.06)] backdrop-blur-xl transition hover:border-gz-primary-cyan/50"
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gz-primary-cyan/10 text-gz-primary-cyan">
                <FaBookOpen size={15} />
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-gz-text-secondary">
        ...
        {/* ================= FOOTER ================= */}
        <div className="hidden items-center justify-between rounded-xl border border-gz-input-border/40 bg-gz-popup/60 px-5 py-2.5 backdrop-blur-xl md:flex">
          <div className="flex items-center gap-2">
            <FaGamepad
              size={17}
              className="text-gz-primary-cyan"
            ...
            <div>
              <p className="text-[10px] font-bold tracking-wider text-gz-primary-cyan">
                PLAY TOGETHER.
              </p>
              <p className="text-[9px] text-gz-text-secondary">
                MAKE GREAT MEMORIES.
              </p>
            </div>
          </div>

          <div className="flex items-center gap-10 text-[10px] text-gz-text-secondary">
            <div className="flex items-center gap-2">
              <FaGamepad className="text-gz-primary-cyan" />
              Fun Games
            </div>

            <div className="flex items-center gap-2">
              <FaUsers className="text-gz-primary-cyan" />
              Real Players
            </div>

            <div className="flex items-center gap-2">
              <FaGift className="text-gz-primary-cyan" />
              Exciting Rewards
            </div>
          </div>
        </div>
