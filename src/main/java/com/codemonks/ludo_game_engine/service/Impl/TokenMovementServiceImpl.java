...
import com.codemonks.ludo_game_engine.service.TokenMovementService;
        ...
        for (PlayerDTO player : gameState.getPlayers()) {
            ...
            if (player.getPendingDice() == null
                ...
                throw new InvalidMoveException(
                        "Consumed dice not found in buffer: " + consumedDice
                );
            }
